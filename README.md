...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/shy-mountain-71c4
```

A live public deployment of this template is available at [https://shy-mountain-71c4.templates.workers.dev](https://shy-mountain-71c4.templates.workers.dev)
